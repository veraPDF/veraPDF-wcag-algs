...
public class ContrastRatioChecker {
	...
	public boolean isTextContrastRatioCompliant(BufferedImage sourceTextImage) {
		return isTextContrastRatioCompliant(sourceTextImage, TextType.REGULAR);
	}

	public boolean isTextContrastRatioCompliant(BufferedImage sourceTextImage, TextType type) {
		return isTextContrastRatioCompliant(sourceTextImage, type, false);
	}
	...
	public double getContrastRatio(BufferedImage sourceTextImage) {
		List<DataPoint> localMaximums = findLocalMaximums(getLuminosityPresenceList(sourceTextImage));
		double[] contrastColors = get2MostPresentElements(localMaximums);
