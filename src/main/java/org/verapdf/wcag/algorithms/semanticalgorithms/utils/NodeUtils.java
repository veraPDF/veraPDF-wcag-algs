...
public class NodeUtils {
	...
	private static final double HEADING_SIZE_FACTOR = 1.5;
	...
	private static final double[] HEADING_PROBABILITY_PARAMS_DIFF_FONT = {0.46, 0.1, 0.4, 0.23, 0.35, 0.1, 0.1};
	...
	private static double headingProbability(SemanticTextNode textNode, SemanticTextNode neighborTextNode, double[] params,
		...
		if (StaticContainers.isDataLoader()) {
			if (textNode.getFontSize() > HEADING_SIZE_FACTOR * neighborTextNode.getFontSize() + fontEps) {
