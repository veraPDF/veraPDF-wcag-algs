...
class AccumulatedNodeSemanticsCheckerTests {
	...
	static {
		...
		ignoredSemanticTypes.add(SemanticType.TABLE_FOOTER);
		ignoredSemanticTypes.add(SemanticType.TABLE_HEADERS);
	...
	static Stream<Arguments> treeSemanticCorrectnessTestParams() {
		return Stream.of(
				...
				Arguments.of("headings/accessible_pdf_webinar_session_ADA-page-4.json"),
				Arguments.of("headings/inline_heading.json"),
				Arguments.of("headings/inline_heading1.json"),
				Arguments.of("headings/inline_heading2.json"),
